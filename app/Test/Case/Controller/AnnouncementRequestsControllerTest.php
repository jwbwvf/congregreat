<?php
App::uses('AnnouncementRequestsController', 'Controller');

/**
 * AnnouncementRequestsController Test Case
 *
 */
class AnnouncementRequestsControllerTest extends ControllerTestCase {
